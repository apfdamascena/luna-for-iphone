...
internal enum Asset {
  ...
  internal static let foliculePhaseActivityCell = ImageAsset(name: "folicule-phase-activity-cell")
  ...
  internal static let ovulationPhaseActivityCell = ImageAsset(name: "ovulation-phase-activity-cell")
  ...
  internal static let pmsPhaseActivityCell = ImageAsset(name: "pms-phase-activity-cell")
